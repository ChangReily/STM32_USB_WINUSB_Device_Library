...
#define USBD_PID_FS     0x7788
#define USBD_PRODUCT_STRING_FS     "Reily USB"
...
__ALIGN_BEGIN uint8_t USBD_WINUSB_OSFeatureDesc[USB_LEN_OS_FEATURE_DESC] __ALIGN_END =
{
   0x28, 0, 0, 0, // length
   0, 1,          // bcd version 1.0
   4, 0,          // windex: Extended Compat ID.Compatibility ID Descriptor Index(4) WINUSB_INDEX_TYPE_OS_FEATURE_DESC
   1,             // no of function
...
__ALIGN_BEGIN uint8_t USBD_WINUSB_OSPropertyDesc[USB_LEN_OS_PROPERTY_DESC] __ALIGN_END =
{
      ...
      0x05, 0x00,   // Extended Properties.Extended properties OS feature descriptor Index(5) WINUSB_INDEX_TYPE_OS_PROPERTY_DESC
